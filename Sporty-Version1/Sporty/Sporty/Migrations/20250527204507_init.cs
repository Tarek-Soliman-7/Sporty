        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetAmountToClub = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MembershipTypes_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MembershipRequests_AspNetUsers_ReviewedByAdminId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MembershipRequests_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MembershipRequests_Clubs_ClubId",
                        column: x => x.ClubId,
                        principalTable: "Clubs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MembershipRequests_MembershipTypes_MembeshipTypeId",
                        column: x => x.MembeshipTypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidatedByID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Documents_MembershipRequests_RequestID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipRequests_BranchId",
                table: "MembershipRequests",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_MembershipRequests_ClubId",
                table: "MembershipRequests",
                column: "ClubId");

            migrationBuilder.CreateIndex(
                name: "IX_MembershipRequests_MembeshipTypeId",
                table: "MembershipRequests",
                column: "MembeshipTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_MembershipRequests_ReviewedByAdminId",
                table: "MembershipRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipTypes_BranchId",
